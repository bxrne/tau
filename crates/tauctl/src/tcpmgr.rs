...
impl Connection {
    ...
    pub(crate) fn open_tls(addr: &str, sni_hostname: &str) -> io::Result<Self> {
    ...
    pub(crate) fn send_raw(&mut self, line: &str) -> io::Result<String> {
    ...
    pub(crate) fn send(&mut self, line: &str) -> io::Result<Response> {
...
impl TcpManager {
    ...
    pub(crate) fn connect(&mut self, name: &str, addr: &str) -> io::Result<()> {
    ...
    /// security caveat.
    pub(crate) fn connect_tls(&mut self, name: &str, addr: &str, sni: &str) -> io::Result<()> {
    ...
    pub(crate) fn disconnect(&mut self, name: &str) -> Result<(), String> {
    ...
    pub(crate) fn set_active(&mut self, name: &str) -> Result<(), String> {
    ...
    pub(crate) fn active_mut(&mut self) -> Option<&mut Connection> {
    ...
    /// connection.
    pub(crate) fn list(&self) -> Vec<(String, String, bool, bool)> {
